...
parser.add_argument('dataset', type=str, choices=['VOCAug', 'VOC2012', 'COCO', 'Cityscapes'])
...
parser.add_argument('--train_size', default=473, type=int, metavar='L', help='size of training patches (default: 473)')
parser.add_argument('--test_size', default=513, type=int, metavar='L', help='size of testing patches (default: 513)')

# ========================= Learning Configs ==========================
parser.add_argument('--epochs', default=48, type=int, metavar='N', help='number of total epochs to run')
